...
var Header = function (_a) {
    var date = _a.date, classes = _a.classes, setDate = _a.setDate, nextDisabled = _a.nextDisabled, prevDisabled = _a.prevDisabled, onClickNext = _a.onClickNext, onClickPrevious = _a.onClickPrevious, _b = _a.months, months = _b === void 0 ? MONTHS : _b;
    ...
    return (React__default.createElement(core.Grid, { container: true, justify: "space-between", alignItems: "center" },
        ...
        React__default.createElement(core.Grid, { item: true },
            React__default.createElement(core.Select, { value: getMonth(date), onChange: handleMonthChange, MenuProps: { disablePortal: true } }, months.map(function (month, idx) { return (React__default.createElement(core.MenuItem, { key: month, value: idx }, month)); }))),
        React__default.createElement(core.Grid, { item: true },
            React__default.createElement(core.Select, { value: getYear(date), onChange: handleYearChange, MenuProps: { disablePortal: true } }, generateYears(date, 30).map(function (year) { return (React__default.createElement(core.MenuItem, { key: year, value: year }, year)); }))),
        React__default.createElement(core.Grid, { item: true, className: classes.iconContainer },
    ...
    return (React.createElement(core.Paper, { square: true, elevation: 0, className: classes.root },
        React.createElement(core.Grid, { container: true },
            React.createElement(Header$1, { date: date, setDate: setDate, nextDisabled: !forward, prevDisabled: !back, onClickPrevious: function () {
                ...
                }, onClickNext: function () { return handlers.onMonthNavigate(marker, NavigationAction.Next); }, months: months }),
            ...
            React.createElement(core.Grid, { item: true, container: true, direction: "column", justify: "space-between", className: classes.daysContainer }, chunks(getDaysInMonth$1(date), 7).map(function (week, idx) { return (React.createElement(core.Grid, { key: idx, container: true, direction: "row", justify: "center" }, week.map(function (day) {
                ...
                return (React.createElement(Day, { key: format(day, "MM-dd-yyyy"), filled: isStart || isEnd, outlined: isToday(day), highlighted: highlighted && !isRangeOneDay, disabled: !isSameMonth(date, day) ||
            ...
            React__default.createElement(core.Grid, null,
                React__default.createElement(core.Grid, { container: true, className: classes.header, alignItems: "center" },
                    React__default.createElement(core.Grid, { item: true, className: classes.headerItem },
                        React__default.createElement(core.Typography, { variant: "subtitle1" }, startDate ? format(startDate, translationProps.dateFormat, { locale: translationProps === null || translationProps === void 0 ? void 0 : translationProps.locale }) : translationProps.startDate)),
                    React__default.createElement(core.Grid, { item: true, className: classes.headerItem },
                        React__default.createElement(ArrowRightAlt, { color: "action" })),
                    React__default.createElement(core.Grid, { item: true, className: classes.headerItem },
                        React__default.createElement(core.Typography, { variant: "subtitle1" }, endDate ? format(endDate, translationProps.dateFormat, { locale: translationProps === null || translationProps === void 0 ? void 0 : translationProps.locale }) : translationProps.endDate))),
                ...
                React__default.createElement(core.Grid, { container: true, direction: "row", justify: "center", wrap: "nowrap" },
                    React__default.createElement(Month$1, __assign({}, commonProps, { value: firstMonth, setValue: setFirstMonth, navState: [true, canNavigateCloser], marker: MARKERS.FIRST_MONTH, weekDays: translationProps === null || translationProps === void 0 ? void 0 : translationProps.weekDays, months: translationProps === null || translationProps === void 0 ? void 0 : translationProps.months })),
                    React__default.createElement("div", { className: classes.divider }),
                    React__default.createElement(Month$1, __assign({}, commonProps, { value: secondMonth, setValue: setSecondMonth, navState: [canNavigateCloser, true], marker: MARKERS.SECOND_MONTH, weekDays: translationProps === null || translationProps === void 0 ? void 0 : translationProps.weekDays, months: translationProps === null || translationProps === void 0 ? void 0 : translationProps.months })))),
            React__default.createElement("div", { className: classes.divider }),
            React__default.createElement(core.Grid, null,
...
var getValidatedMonths = function (range, minDate, maxDate) {
    ...
    if (startDate && endDate) {
        var newStart = max([startDate, minDate]);
        var newEnd = min([endDate, maxDate]);
...
var DateRangePickerImpl = function (props) {
    ...
    var onMonthNavigate = function (marker, action) {
        if (marker == MARKERS.FIRST_MONTH) {
            var firstNew = addMonths(firstMonth, action);
            if (isBefore(firstNew, secondMonth))
                setFirstMonth(firstNew);
        }
        else {
            var secondNew = addMonths(secondMonth, action);
